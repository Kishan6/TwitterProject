...
print ("Average statuses for depressed = ", (dep_statuses/dep_count))
print ("Average followers for depressed = ", (dep_followers/dep_count))
print ("Average friends for depressed = ", (dep_friends/dep_count))
print ("Average favourites for depressed = ", (dep_favourites/dep_count))
print ('\n\n')